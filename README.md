Building tools for agents that do real work. Read [my blog](https://michaellivs.com), follow me on [𝕏](https://twitter.com/micLivs).
...
|---------|-------------|---|
| [pi-generative-ui](https://github.com/Michaelliv/pi-generative-ui) | Claude.ai's generative UI — reverse-engineered, rebuilt for… | 1161 |
| [psst](https://github.com/Michaelliv/psst) | AI-native secrets manager. Agents use secrets without seein… | 237 |
| [pi-goal](https://github.com/Michaelliv/pi-goal) | Persistent autonomous goals for pi | 223 |
...
| [dripline](https://github.com/Michaelliv/dripline) | 💧 Query mode for agents | 108 |
| [poster](https://github.com/Michaelliv/poster) | 🎨 Single-file distributable React posters — one .tsx file,… | 72 |
...
| [agentbox](https://github.com/Michaelliv/agentbox) | A computer for your agent - sandboxed code execution for AI… | 49 |
| [pi-websearch](https://github.com/Michaelliv/pi-websearch) | 🔍 Web search for pi — 12 providers, one tool. Pick what you… | 48 |
| [pi-charts](https://github.com/Michaelliv/pi-charts) | Chart rendering for pi — bar, line, pie, scatter, radar, fu… | 42 |
...
| [agent-harness](https://github.com/Michaelliv/agent-harness) | Open source primitives for agent context management | 18 |
| [agent-jail](https://github.com/Michaelliv/agent-jail) | ⛓️ Portable filesystem sandbox for spawning untrusted subpr… | 11 |
...
| [nanny](https://github.com/Michaelliv/nanny) | The dumb task loop for smart agents. Ralph Wiggum loops wit… | 9 |
| [pi-ask-user-question](https://github.com/Michaelliv/pi-ask-user-question) | ❓ Interactive multi-choice question tool for pi — clarify r… | 8 |
