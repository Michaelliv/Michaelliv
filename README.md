...
|---------|-------------|---|
| [pi-generative-ui](https://github.com/Michaelliv/pi-generative-ui) | Claude.ai's generative UI — reverse-engineered, rebuilt for… | 765 |
...
| [dripline](https://github.com/Michaelliv/dripline) | Query mode for agents. | 43 |
